<script lang="ts">
	...
	const queryVectorColor = 'bg-gray-200';
	const keyVectorColor = 'bg-black-200';
	const valVectorColor = 'bg-black-200';

	const queryHeadVectorColor = 'bg-gray-300';
	const keyHeadVectorColor = 'bg-gray-300';
	const valHeadVectorColor = 'bg-gray-300';

	const outputVectorColor = 'bg-gray-300';
			...
			{#each $tokens as token, index}
				...
				>
					<div class={`sub-vector query relative flex grow flex-col ${queryVectorColor}`}>
						<VectorCanvas colorScale="gray" active={vectorHoverIdx === index} />
					...
					<div class={`sub-vector key relative flex grow flex-col ${keyVectorColor}`}>
						<VectorCanvas colorScale="black" active={vectorHoverIdx === index} />
